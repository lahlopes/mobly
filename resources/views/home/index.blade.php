...
<div class="container">
		...
		<div class="col s12 m6 l4">
			<div class="card medium">
				<div class="card-image">
					<a class="blue-text" href="{{ route('produto', $registro->id) }}"><img src="images/{{ $registro->imagem }}"></a>
				</div>
				<div class="card-content">
					<span class="card-title grey-text text-darken-4" title="{{ $registro->nome }}">{{ $registro->nome }}</span>
	...
	<div class="row">
	{{ $registros->appends(['search' => isset($search) ? $search : ''])->links() }}
	</div>
</div>
